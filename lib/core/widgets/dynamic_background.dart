...
class _DynamicBackgroundState extends State<DynamicBackground>
  ...
  Widget build(BuildContext context) {
    const bgImage = 'assets/images/night.jpg';
            ...
            return Stack(
              children: [
                _buildAura(
                  ...
                  color: const Color(0xFF1B0B2E), // Deep Night Purple
                  radius: 2.0,
                  opacity: 0.6,
                ),
                _buildAura(
                  ...
                  color: const Color(0xFF0A0214), // Almost Black
                  radius: 2.5,
                  opacity: 0.5,
                ),
                _buildAura(
                  ...
                  color: const Color(0xFF2D1142), // Rich Violet
                  radius: 1.8,
                  opacity: 0.4,
                ),
              ],
